...
which model would be best at accounting for variability in the raw number of opioid poisoning deaths.

Then, variables in the larger model were removed starting with the highest VIF until no variables 

had a VIF score greater than 10.
