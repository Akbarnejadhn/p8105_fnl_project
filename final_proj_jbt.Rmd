...
ggplot(treatment_death_final, 
  ...
  ggtitle("# Opioid Deaths vs. Distance to Treatment Facility")

ggplot(treatment_death_final, aes(x = distance, y = deaths_rate)) +
  geom_point() + xlab("Distance (miles)") + ylab("Death Rate") +
  ggtitle("Death Rate vs. Distance to Treatment Facility")
```
...
Next we load in data noting the locations of various pill "take-back" boxes around NYC, counting and sorting by county. These boxes are a public health initiative intended to encourage responsible use and disposal of opioids.
